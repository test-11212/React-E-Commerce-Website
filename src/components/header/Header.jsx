                  ...
                  >
                    <ul>
                      ...
                      >
                        ...
                        <li>
                          <Link to={ROUTES.STORES} onClick={(e) => { e.preventDefault(); mixpanel.track('nav_link_clicked', { position: 'navbar', text_link: ROUTES.STORES }); navigate(ROUTES.STORES); }}>Stores</Link>
                        </li>
                        <li>
